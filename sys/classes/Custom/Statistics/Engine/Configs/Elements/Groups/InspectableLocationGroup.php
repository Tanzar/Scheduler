...
/**
 * Description of InspectableLocationGroup
 *
 * @author Tanzar
 */
class InspectableLocationGroup  extends Group{
    private Container $locations;
    
    public function __construct(int $value) {
        parent::__construct(Groups::InspectableLocation, $value);
        $view = new LocationDetailsView();
        $this->locations = $view->getInspectable();
    }
