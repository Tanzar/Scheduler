...
class DaysDetails {
    ...
    private function setWorkdayTimes(Container $entry, DateTime $dayStart, DayDetails $details) : void {
        $this->setStartDayDetails($entry, $dayStart, $details);
        $this->setEndDayDetails($entry, $dayStart, $details);
    }
