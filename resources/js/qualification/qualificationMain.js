...
function initQualificationsTableButtons(language, qualificationsTable, personsTable){
    qualificationsTable.addActionButton(language.add, function(){
        RestApi.post('Qualification', 'getQualificationOptions', {},
            function(response){
                var data = JSON.parse(response);
                var ougs = [];
                ...
                openModalBox(language.new_qualification, fields, language.save, function(data){
                    ...
                    if(person !== undefined){
                        ...
                        RestApi.post('Qualification', 'saveQualification', data,
                            function(response){
                                var data = JSON.parse(response);
                                console.log(data);
                                alert(data.message);
    ...
    qualificationsTable.addActionButton(language.remove, function(selected){
        if(selected !== undefined){
            RestApi.post('Qualification', 'removeQualification', {id: selected.id},
                function(response){
                    var data = JSON.parse(response);
                    console.log(data);
                    alert(data.message);
