    ...
    RestApi.getInterfaceNamesPackage(function(language){
        ...
        datatable.addActionButton(language.assign, function(selected){
            if(selected !== undefined){
                RestApi.post('InspectorDocuments', 'assignUser', {id: selected.id}, function(response){
                    var data = JSON.parse(response);
                    console.log(data);
                    alert(data.message);
                    clearUsersList();
        ...
        datatable.setOnSelect(function(item){
            RestApi.post('InspectorDocuments', 'getDocumentUsers', {id: item.id}, function(response){
                var data = JSON.parse(response);
                console.log(data);
                clearUsersList();
