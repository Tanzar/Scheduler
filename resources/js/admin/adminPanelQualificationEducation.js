...
function initEducationsTable(language, personTable){
    ...
    datatable.addActionButton(language.add, function(){
        ...
        if(person !== undefined){
            ...
            openModalBox(language.new_school, fields, language.save, function(data){
                ...
                RestApi.post('AdminPanelQualification', 'saveEducation', data,
                    function(response){
    ...
    datatable.addActionButton(language.change_status, function(selected){
        if(selected !== undefined){
            RestApi.post('AdminPanelQualification', 'changeEducationStatus', {id: selected.id},
                function(response){
                    var data = JSON.parse(response);
                    console.log(data);
                    alert(data.message);
...
function initCoursesTable(language, personTable){
    ...
    datatable.addActionButton(language.add, function(){
        ...
        if(person !== undefined){
            ...
            openModalBox(language.new_course, fields, language.save, function(data){
                data.id_person = person.id;
                RestApi.post('AdminPanelQualification', 'saveCourse', data,
                    function(response){
                        var data = JSON.parse(response);
                        console.log(data);
                        alert(data.message);
    ...
    datatable.addActionButton(language.change_status, function(selected){
        if(selected !== undefined){
            RestApi.post('AdminPanelQualification', 'changeCourseStatus', {id: selected.id},
                function(response){
                    var data = JSON.parse(response);
                    console.log(data);
                    alert(data.message);
