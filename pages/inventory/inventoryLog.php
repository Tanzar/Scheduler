    ...
    <body>
        ...
        <div class="page-contents" id="pageContents">
            <div class="horizontal-container">
                <button class="standard-button", id="addFilter">
                    <?php echo $interface->get('add_filter'); ?>
                </button>
                <div id="filters"></div>
            </div>
