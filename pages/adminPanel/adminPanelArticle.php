...
<html>
    <head>
        ...
        <?php
            ...
            Resources::linkJS('adminPanelArticle.js');
    ...
    <body>
        ...
        <div class="page-contents" id="display">
            <div class="horizontal-container">
                <div>
                    <div class="standard-text-title"><?php echo $interfaceText->get('art_41'); ?></div>
                    <div class="horizontal-container">
                ...
                <div>
                    <div class="standard-text-title"><?php echo $interfaceText->get('art_41_form'); ?></div>
                    <div id="articleForms"></div>
                </div>
            </div>
        </div>
        <?php
