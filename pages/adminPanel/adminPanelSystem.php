...
<html>
    <head>
        ...
        <?php
            ...
            Resources::linkJS('adminPanelSystem.js');
    ...
    <body>
        ...
        <div class="page-contents-centered" id="display">
            <div class="standard-text-title">
                <?php echo $interfaceText->get('system_operations'); ?>
            </div>
            <button id="backup" class="standard-button"><?php echo $interfaceText->get('backup'); ?></button>
            <button id="fix" class="standard-button"><?php echo $interfaceText->get('fix_database'); ?></button>
            <button id="clear" class="standard-button"><?php echo $interfaceText->get('clear_database'); ?></button>
        </div>
        <?php
