...
<html>
    <head>
        ...
        <?php
            ...
            Resources::linkJS('adminPanelQualificationSettings.js');
            ...
            <div class="horizontal-container">
                <div class="centered-contents">
                    <div class="standard-text">
                        <?php echo $interfaceText->get('supervision_levels'); ?>
                    </div>
                    <div id="supervisionLevels"></div>
                </div>
                <div class="centered-contents">
                    <div class="standard-text">
                        <?php echo $interfaceText->get('oug_offices'); ?>
                    </div>
                    <div id="offices"></div>
                </div>
                <div class="centered-contents">
                    <div class="standard-text">
                        <?php echo $interfaceText->get('facility_types'); ?>
                    </div>
                    <div id="facilityTypes"></div>
                </div>
            </div>
        </div>
        <?php
